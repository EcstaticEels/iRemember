    ...
    <div className="home-container-secondary">
      <div className="home-container">
        <div className="home-box">
          ...
          <br />
          <br />
          iRemember gives caregivers the ability to set reminders remotely for their loved ones and recognize important people in their lives using their mobile devices.</h2>
